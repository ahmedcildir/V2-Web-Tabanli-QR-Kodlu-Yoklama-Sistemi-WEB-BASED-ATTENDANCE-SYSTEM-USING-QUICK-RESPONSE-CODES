<%@ Page Title="" Language="C#" MasterPageFile="~/anasayfa.Master" AutoEventWireup="true" CodeBehind="kullaniciEkle.aspx.cs" Inherits="YoklamaSistemi.form.kullaniciEkle" %>
        ...
        <div class="col-md-12 col-sm-6 col-xs-12">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="info-box-number">KULLANICI KAYIT</span>
                ...
                <table class="table table-borderless">
                    <tbody>
                        ...
                        <tr>
                            <td>Görev :</td>
                            <td>
                                <asp:DropDownList ID="dropgorev" class="form-control bg-black select2" runat="server">
