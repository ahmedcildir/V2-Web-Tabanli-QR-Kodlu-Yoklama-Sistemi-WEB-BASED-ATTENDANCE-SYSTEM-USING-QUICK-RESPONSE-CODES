<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="dersler.aspx.cs" Inherits="YoklamaSistemi.teacher.dersler" %>
                ...
                <table class="table table-striped ">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="col col-lg-1 col-xs-1">DERS KOD</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Algoritma</td>
                            <td>4</td>
                            <td>Açıklama Kısmı Açıklama Kısmı Açıklama Kısmı Açıklama Kısmı </td>
                            <td>
                                <a href="ogrDevamsizlikGoster.aspx" class="btn btn-primary btn-xs" role="button">Ogr. Göster</a>
                                <a href="dersDuzenleme.aspx" class="btn btn-warning  btn-xs" role="button">Düzenle</a>
