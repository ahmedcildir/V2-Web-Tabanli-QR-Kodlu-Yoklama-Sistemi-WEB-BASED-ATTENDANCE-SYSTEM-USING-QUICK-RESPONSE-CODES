<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="YoklamaSistemi.form.login" %>
        ...
        <div class="login-box-body">
            ...
            <form id="form1" runat="server" action="#" method="post">
                ...
                <div class="row">
                    ...
                    <!-- /.col -->
                    <div class="col-xs-4">
                        <asp:Button ID="btngiris" type="submit" class="btn btn-primary btn-block btn-flat" runat="server" Text="Giriş" OnClick="btngiris_Click" />
                    </div>
                    <!-- /.col -->
                </div>
            </form>
