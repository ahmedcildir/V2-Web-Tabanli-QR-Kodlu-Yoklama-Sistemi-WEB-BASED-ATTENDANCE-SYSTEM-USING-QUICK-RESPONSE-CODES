<%@ Page Title="" Language="C#" MasterPageFile="~/anasayfa.Master" AutoEventWireup="true" CodeBehind="profil.aspx.cs" Inherits="YoklamaSistemi.form.profil" %>
                ...
                <ItemTemplate>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-widget widget-user">
                            ...
                            <div class="widget-user-header bg-black" style="background: url('<%# Eval("foto2") %>') center center;">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 border-right">
                                        <div class="description-block">
                                            ...
                                            <span class="description-text"><%# Eval("name") %>&nbsp;<%# Eval("surname") %></span></div>
                                        <!-- /.description-block -->
                                    </div>
                                    <!-- /.col -->
                                    <div class="col-sm-4 border-right">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="description-block">
                                            ...
                                            <span class="description-text"><%# Eval("kategori") %></span>
                                        </div>
                                        <!-- /.description-block -->
                                    </div>
                                    <!-- /.col -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <asp:Button ID="btnArkafotokayıt" runat="server" class="btn btn-outline" Text="Kaydet" OnClick="btnArkafotokayıt_Click" />
    ...
    <div class="modal modal-info fade" id="modal-info1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Kapat</button>
                    <asp:Button ID="btnfotoKayit" runat="server" class="btn btn-outline" Text="Kaydet" OnClick="btnfotoKayit_Click" />
    ...
    <div class="modal modal-info fade" id="modal-info-edit">
        <div class="modal-dialog">
            <div class="modal-content">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtAd" ErrorMessage="Ad Kısmı Boş Geçilemez." ForeColor="Red">*</asp:RequiredFieldValidator>
                           ...
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtDogumTarihi" ErrorMessage="Doğum Tarihi Kısmı Boş Geçilemez." ForeColor="Red">*</asp:RequiredFieldValidator>
                            ...
                            <tr>
                                <td>Görev :</td>
                                <td>
                                    <asp:DropDownList ID="dropduzen" class="form-control select2" runat="server">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Kapat</button>
                    <asp:Button ID="btnguncelle" runat="server" class="btn btn-outline" Text="Kaydet" OnClick="btnguncelle_Click" />
