<%@ Page Title="" Language="C#" MasterPageFile="~/anasayfa.Master" AutoEventWireup="true" CodeBehind="yoneticiKayit.aspx.cs" Inherits="YoklamaSistemi.form.yoneticiKayit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row ">
        <div class="col-md-12 col-sm-6 col-xs-12">
            <div class="info-box">
                <span class="info-box-icon bg-green"><i class="fa ion-person-add"></i></span>

                <div class="info-box-content">
                    <span class="info-box-number">YÖNETİCİ KAYIT</span>
